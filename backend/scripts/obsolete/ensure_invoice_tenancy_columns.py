...
Moved to scripts/obsolete/ — superseded by Alembic (invoice columns in baseline migrations).

Run from backend: python -m scripts.obsolete.ensure_invoice_tenancy_columns
"""
import os
import sys
